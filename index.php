...
$user_permissions = [
    ...
    'Nabila' => [
        ...
        'allowed' => [
            ...
            'Physics' => [
                'নিউটনীয় বলবিদ্যা' => 'ALL',
                'কাজ, শক্তি ও ক্ষমতা' => 'ALL',
...
$allowed_ips = ['202.181.4.166', '103.174.215.88', '116.206.255.42', '103.144.49.105', '103.133.201.168', '43.245.120.36', '103.138.120.32', '104.28.166.114', '103.51.2.19', '103.42.53.224']; 
$allowed_devices = ['832c0468e1719fe896d4a7a3', 'a3d7b4a440f1416b96b5522d', '3861012ecf7f00e0630a375e', '833e2a5a3d7b908de4bf619d', '2577a9cc6a36d8fe0a237c1b', '775fab6abff4c3e9ea6dd631', '05e2aa8373f3618b28718085', 'c700802c75fd953974bb1ba8', 'aa9cc3d0485f849119091d99']; 
    ...
    <div class="container">
        ...
        <div id="subject-screen">
            ...
            <div class="search-wrapper">
                <input type="text" id="search-box" placeholder="নির্দিষ্ট ভিডিও দেখতে কীওয়ার্ডটি বসান... (যেমন: P1stC1C1)">
